package com.emdd.friendscircle.adapters;
...
import com.emdd.friendscircle.Constants;
import com.emdd.friendscircle.R;
import com.emdd.friendscircle.beans.FriendCircleBean;
import com.emdd.friendscircle.beans.OtherInfoBean;
import com.emdd.friendscircle.beans.UserBean;
import com.emdd.friendscircle.enums.TranslationState;
import com.emdd.friendscircle.interfaces.OnItemClickPopupMenuListener;
import com.emdd.friendscircle.interfaces.OnPraiseOrCommentClickListener;
import com.emdd.friendscircle.span.TextMovementMethod;
import com.emdd.friendscircle.utils.TimerUtils;
import com.emdd.friendscircle.utils.Utils;
import com.emdd.friendscircle.widgets.CommentOrPraisePopupWindow;
import com.emdd.friendscircle.widgets.NineGridView;
import com.emdd.friendscircle.widgets.VerticalCommentWidget;
...
import static com.emdd.friendscircle.Constants.FriendCircleType.FRIEND_CIRCLE_TYPE_HEADER;
...
public class FriendCircleAdapter extends RecyclerView.Adapter<FriendCircleAdapter.BaseFriendCircleViewHolder>
    ...
    public BaseFriendCircleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == FRIEND_CIRCLE_TYPE_HEADER) {
            return new HeaderViewHolder(mLayoutInflater.inflate(R.layout.layout_friends_circle_header,parent, false));
    ...
    public int getItemViewType(int position) {
        if (position == 0) return FRIEND_CIRCLE_TYPE_HEADER;
