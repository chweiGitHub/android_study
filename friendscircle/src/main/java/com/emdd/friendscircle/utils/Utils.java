package com.emdd.friendscircle.utils;
...
import com.emdd.friendscircle.interfaces.OnStartSwipeRefreshListener;
...
public class Utils {
    ...
    public static int dp2px(float dpValue) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dpValue, BaseApplication.sContext.getResources().getDisplayMetrics());
    }
